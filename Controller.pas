    ...
    procedure TForm1.runButtonClick(Sender: TObject);
      begin
        ...
        CurrDate := Now;
            ...
            ExcelApp.WorkBooks.Item[1].SaveAs(WideString(LogFileName(CurrDate)));
...
//===================================SaveToFile===================================
  ...
  procedure TForm1.SaveToFile(FData:Variant;LogCounter:Integer);
   ...
   begin
    ...
    try
      ExcelApp.Workbooks.Open(WideString(LogFileName(CurrDate)));
...
//=============================Formatting the string================================
    ...
    procedure TForm1.ReqPressureEditKeyPress(Sender: TObject; var Key: Char);
      const
        Digit: set of Char=['0'..'9',Char($8),Char($2E)];
